...
import { initialData } from "../frontend/src/services/localDbClient.js";
...
const COLUMNAS_INSCRIPCIONES = [
  "id", "dniEstudiante", "programaId", "estadoPago", "pagoId",
...
const COLUMNAS_PAGOS = ["id", "inscripcionId", "dniEstudiante", "programaId", "monto", "formaPago", "numeroOperacion", "telefonoOperacion", "capturaPagoNombre", "capturaPagoBase64", "estado", "fechaPago", "origenRegistro", "nro_recibo"];
const COLUMNAS_ASISTENCIAS = ["id", "inscripcionId", "pagoId", "dniEstudiante", "programaId", "estadoAcceso", "observacion", "origen", "fechaRegistro"];
