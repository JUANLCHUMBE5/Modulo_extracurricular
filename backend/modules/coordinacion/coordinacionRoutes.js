...
router.post("/api/v1/extracurricular/programas", requireRole(["coordinacion"]), async (req, res) => {
  try {
    ...
    const nuevo = {
      ...
      usarFechaLimiteInscripcion: Boolean(req.body.usar_fecha_limite_inscripcion),
      fechaAperturaInscripcion: req.body.fecha_apertura_inscripcion || "",
      horaAperturaInscripcion: req.body.hora_apertura_inscripcion || "",
      fechaLimiteInscripcion: req.body.fecha_limite_inscripcion || "",
      horaLimiteInscripcion: req.body.hora_limite_inscripcion || "23:59",
...
router.put("/api/v1/extracurricular/programas/:id", requireRole(["coordinacion"]), async (req, res) => {
  try {
    ...
    const updated = {
      ...
      requiereUniforme: Boolean(req.body.requiere_uniforme),
      requiereIndumentaria: Boolean(req.body.requiere_indumentaria),
      usarFechaLimiteInscripcion: req.body.usar_fecha_limite_inscripcion !== undefined ? Boolean(req.body.usar_fecha_limite_inscripcion) : Boolean(db.programas[idx].usarFechaLimiteInscripcion),
      fechaAperturaInscripcion: req.body.fecha_apertura_inscripcion ?? db.programas[idx].fechaAperturaInscripcion ?? "",
      horaAperturaInscripcion: req.body.hora_apertura_inscripcion ?? db.programas[idx].horaAperturaInscripcion ?? "",
      fechaLimiteInscripcion: req.body.fecha_limite_inscripcion ?? db.programas[idx].fechaLimiteInscripcion ?? "",
      horaLimiteInscripcion: req.body.hora_limite_inscripcion ?? db.programas[idx].horaLimiteInscripcion ?? "23:59",
      anuncioImagen: req.body.anuncio_imagen || "",
      anuncioImagenNombre: req.body.anuncio_imagen_nombre || "",
      talleresDeportivos: req.body.talleres_deportivos || [],
      horariosPorGrupo: req.body.horarios_por_grupo || [],
