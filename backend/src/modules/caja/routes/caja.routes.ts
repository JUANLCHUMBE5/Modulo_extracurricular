...
import { RegistrarPagoSchema, RegistrarEgresoSchema, AccionPagoSchema, CancelarCorrelativoSchema } from "../dtos/caja.dto.js";
...
router.post("/api/v1/extracurricular/pagos", requireAuth, requireRole(["caja"]), validateBody(RegistrarPagoSchema), (req, res) => controller.registrarPago(req, res));
...
router.post("/api/v1/extracurricular/caja/egresos", requireAuth, requireRole(["caja"]), validateBody(RegistrarEgresoSchema), (req, res) => controller.registrarEgreso(req, res));
...
router.put("/api/v1/extracurricular/pagos/:pagoId/validar", requireAuth, requireRole(["caja"]), validateBody(AccionPagoSchema), (req, res) => controller.validarPago(req, res));
router.put("/api/v1/extracurricular/pagos/:pagoId/observar", requireAuth, requireRole(["caja"]), validateBody(AccionPagoSchema), (req, res) => controller.observarPago(req, res));
router.put("/api/v1/extracurricular/pagos/:pagoId/rechazar", requireAuth, requireRole(["caja"]), validateBody(AccionPagoSchema), (req, res) => controller.rechazarPago(req, res));
router.put("/api/v1/extracurricular/pagos/:pagoId/anular", requireAuth, requireRole(["caja", "direccion"]), validateBody(AccionPagoSchema), (req, res) => controller.anularPago(req, res));
...
router.post("/api/v1/extracurricular/caja/correlativos/cancelar", requireAuth, requireRole(["caja"]), validateBody(CancelarCorrelativoSchema), (req, res) => controller.cancelarCorrelativo(req, res));
