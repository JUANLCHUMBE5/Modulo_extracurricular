...
Aunque el backend inicializa el esquema automáticamente al conectar por primera vez, aquí tienes el script SQL completo de la estructura relacional por si necesitas crearlo manualmente o verificarlo en PGAdmin:
