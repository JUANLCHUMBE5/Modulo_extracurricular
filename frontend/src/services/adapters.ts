...
export function adaptarPrograma(apiPrograma) {
  ...
  return {
    ...
    usarFechaLimiteInscripcion: apiPrograma.usar_fecha_limite_inscripcion !== undefined ? Boolean(apiPrograma.usar_fecha_limite_inscripcion) : Boolean(apiPrograma.usarFechaLimiteInscripcion),
    fechaAperturaInscripcion: apiPrograma.fecha_apertura_inscripcion || apiPrograma.fechaAperturaInscripcion || "",
    horaAperturaInscripcion: apiPrograma.hora_apertura_inscripcion || apiPrograma.horaAperturaInscripcion || "",
    fechaLimiteInscripcion: apiPrograma.fecha_limite_inscripcion || apiPrograma.fechaLimiteInscripcion || "",
    horaLimiteInscripcion: apiPrograma.hora_limite_inscripcion || apiPrograma.horaLimiteInscripcion || "23:59",
...
export function adaptarInscripcion(apiInscripcion) {
  ...
  return {
    ...
    estadoPrograma: apiInscripcion.estado_programa || apiInscripcion.estadoPrograma || "Habilitado",
    usarFechaLimiteInscripcion: apiInscripcion.usar_fecha_limite_inscripcion !== undefined ? Boolean(apiInscripcion.usar_fecha_limite_inscripcion) : Boolean(apiInscripcion.usarFechaLimiteInscripcion),
    fechaLimiteInscripcion: apiInscripcion.fecha_limite_inscripcion || apiInscripcion.fechaLimiteInscripcion || "",
    horaLimiteInscripcion: apiInscripcion.hora_limite_inscripcion || apiInscripcion.horaLimiteInscripcion || "23:59",
    fechaAperturaInscripcion: apiInscripcion.fecha_apertura_inscripcion || apiInscripcion.fechaAperturaInscripcion || "",
    horaAperturaInscripcion: apiInscripcion.hora_apertura_inscripcion || apiInscripcion.horaAperturaInscripcion || "",
