...
import useCoordinacionAsistencias from "../../hooks/useCoordinacionAsistencias";
import AsistenciaDiariaTable from "./AsistenciaDiariaTable";
import AsistenciaMensualTable from "./AsistenciaMensualTable";

/**
 * Vista central de asistencia y control diario/mensual de estudiantes para Coordinación.
 */
function AsistenciasView({
  ...
  return (
    <>
      {/* Barra superior con título y toggle de menú */}
      ...
      <section className="coord-workspace coord-workspace-single">
        <article className="coord-card coord-search-card">
          <div className="coord-card-title" style={{ display: "flex", gap: "10px", alignItems: "center", marginBottom: "8px" }}>
            <span className="coord-title-icon" style={{ width: "32px", height: "32px" }}>
              <UserCheck size={18} />
            </span>
            <div>
          ...
          {/* Fila de filtros y acciones de exportación */}
          <div className="coord-filtros-card-mantine" style={{ padding: "0", background: "transparent", border: "none", marginBottom: "8px" }}>
            <div className="coord-filtros-row-mantine" style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-end", gap: "8px" }}>
              ...
              {/* Botones de Descarga en PDF/Excel */}
          ...
          {/* Detalle del Horario Resolutivo del Grado */}
          ...
          {/* Controles de cambio de Vista y Buscador */}
          {tallerId && !cargando && (!selectGradosData.length || gradoSeleccionado) && (
            <div style={{ display: "flex", justify: "space-between", alignItems: "center", gap: "12px", marginBottom: "10px", flexWrap: "wrap" }}>
              <SegmentedControl
                value={vistaTipo}
          ...
          {/* Renderizado de tablas y loaders */}
          {cargando ? (
            ...
            (grupoActivo || (asistencias.length === 0 && hasMatriculados)) ? (
              <div style={{ marginTop: "8px" }}>
                ...
                {/* Selector visual de fechas diarias */}
                {grupoActivo ? (
